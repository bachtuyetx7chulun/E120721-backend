    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                if (!(currentCovidData.time.date == parse_util_1.parseCurrentTime())) return [3 /*break*/, 5];
                return [4 /*yield*/, db_1.default
...
exports.crawlDetail = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db_1.default
                        .ref('covids/overview/' + parse_util_1.parseCurrentTime())
                        .set(dimension)];
            case 2:
                // TODO: Overide all records in the firebase database realtime
                _a.sent();
